  ...
  parse(arch, models, modelName, jsClass) {
    ...
    visitXML(arch, (node) => {
      if (node.tagName === 'button') {
        ...
        const fieldInfo = Field.parseFieldNode(node, models, modelName, 'init_tree', jsClass);
...
export class InitTreeArchParser {
  parseFieldNode(node, models, modelName) {
    return Field.parseFieldNode(node, models, modelName, 'init_tree');
  }
  ...
  parse(xmlDoc, models, modelName) {
    ...
    visitXML(xmlDoc, (node) => {
      ...
      if (node.tagName === "button") {
        ...
        return false;
      } else if (['init_tree'].includes(node.tagName)) {
        const activeActions = {
