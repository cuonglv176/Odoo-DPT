...
class DPTExpenseAllocation(models.Model):
    ...
    total_expense = fields.Money(string='Total Expense', currency_field='currency_id')
    total_expense_in_main_currency = fields.Money(string='Total Expense In Main Currency',
