...
class HrEmployee(models.Model):
    ...
    registration_number = fields.Char('Mã số thuê', groups="hr.group_hr_user", copy=False)
...
class HrEmployeePublic(models.Model):
    ...
    parent_department_id = fields.Many2one('hr.department', string='Phòng', related='employee_id.parent_department_id',
                                           compute_sudo=True)
